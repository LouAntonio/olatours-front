	...
	return (
		<div className="min-h-dvh bg-[#f5c300] text-[#4a2611] overflow-hidden">
			<section className="relative isolate overflow-hidden">
				<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.18),_transparent_32%),radial-gradient(circle_at_85%_12%,_rgba(255,84,36,0.16),_transparent_18%),linear-gradient(180deg,_rgba(255,214,72,0.25),_rgba(245,195,0,0.08))]" />
				<div className="pointer-events-none absolute -top-14 left-[-6rem] h-64 w-64 rounded-full bg-[#b33d1f]/12 blur-3xl" />
						...
						<motion.div variants={item} className="lg:col-span-7">
							...
							<div className="mt-8 flex flex-wrap gap-3">
								...
								<Button
									...
									variant="outline"
									size="lg"
									className="border-[#4a2611]/25 text-[#4a2611] hover:border-[#4a2611] hover:bg-[#fff6ce]"
								>
									Ver detalhes
								</Button>
							</div>
						...
						>
							<div className="relative mx-auto flex w-full max-w-[560px] flex-col items-center lg:items-end">
								...
								<img
									...
									alt="OlaTours"
									className="mt-4 h-24 w-auto object-contain self-start"
								/>
							</div>
						</motion.div>
					</motion.div>
					...
					<div className="mx-auto max-w-3xl text-center">
						...
						<div className="mt-8 mx-auto max-w-lg space-y-4 rounded-[28px] border border-[#4a2611]/15 bg-white/45 p-5 shadow-[0_18px_40px_-26px_rgba(74,38,17,0.32)] backdrop-blur-sm text-left">
							{pickupPoints.slice(0, 4).map((point) => (
								<div
									key={point}
									className="flex items-center justify-between gap-4 border-b border-[#4a2611]/10 pb-3 last:border-b-0 last:pb-0"
								>
