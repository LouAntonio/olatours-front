	...
	return (
		<div className="max-w-2xl">
			...
			>
				...
				{profileMsg && (
					<div className="bg-green-50 border border-green-200 rounded-sm px-4 py-3 text-green-700 text-sm">
						{profileMsg}
					</div>
				)}
				{profileError && (
			...
			<form
				...
				className="bg-white border border-gray-border/60 rounded-lg p-5 space-y-4"
			>
				<h2 className="label-caps text-ink-mute text-xs uppercase tracking-wider">
